...
export default function RegisterPage() {
  ...
  const valid = name.trim().length > 0 && email.includes('@') && password.length >= 6
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <svg width={28} height={28} viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth={2.2}>
          ...
          <p style={{ margin: '0 0 24px', fontSize: 15, color: 'var(--ink-3)', lineHeight: 1.55 }}>
            ...
            <strong style={{ color: 'var(--ink)' }}>{email}</strong>. Haz clic en él para activar tu
            cuenta.
          </p>
          <Link
            href="/login"
